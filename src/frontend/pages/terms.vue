<template>
  <v-container class="pt-16">
    ...
    <BodyText>
      ...
      {{ appName }}&#39;s Website, located at {{ siteUrl }}.
    </BodyText>

    <BodyText>
      By accessing this website we assume you accept these terms and conditions. Do not continue to
      use {{ appName }} if you do not agree to take all of the terms and conditions stated on this
      page.
    </BodyText>
    ...
    <BodyText>
      ...
      to the Client in the most appropriate manner for the express purpose of meeting the
    ...
    <BodyText>
      We employ the use of cookies. By accessing {{ appName }}, you agreed to use cookies in
      agreement with the {{ appName }}&#39;s Privacy Policy.
    </BodyText>
    ...
    <BodyText>
      Unless otherwise stated, {{ appName }} and/or its licensors own the intellectual property
      rights for all material on {{ appName }}. All intellectual property rights are reserved. You
      may access this from {{ appName }} for your own personal use subjected to restrictions set in
    ...
    <BodyText>
      ...
      information in certain areas of the website. {{ appName }} does not filter, edit, publish or
      review Comments prior to their presence on the website. Comments do not reflect the views and
      opinions of {{ appName }},its agents and/or affiliates. Comments reflect the views and
      opinions of the person who post their views and opinions. To the extent permitted by
      applicable laws, {{ appName }} shall not be liable for the Comments or for any liability,
      damages or expenses caused and/or suffered as a result of any use of and/or posting of and/or
      appearance of the Comments on this website.
    </BodyText>

    <BodyText>
      {{ appName }} reserves the right to monitor all Comments and to remove any Comments which can
    ...
    <BodyText>
      You hereby grant {{ appName }} a non-exclusive license to use, reproduce, edit and authorize
    ...
    <Heading
      variant="h6"
      class="mt-4 mb-2"
      >Hyperlinking to our Content</Heading
    >
    ...
    <BodyText>
      ...
      visibility of the hyperlink compensates the absence of {{ appName }}; and (d) the link is in
    ...
    <BodyText>
      ...
      to our website, you must inform us by sending an e-mail to {{ appName }}. Please include your
    ...
    <BodyText>
      No use of {{ appName }}&#39;s logo or other artwork will be allowed for linking absent a
    ...
    <Heading
      variant="h6"
      class="mt-4 mb-2"
      >Removal of links from our website</Heading
    >
...
const { appName, siteUrl } = runtimeConfig.public;
const { t } = useI18n();
