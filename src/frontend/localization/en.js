export default {
  ...
  pages: {
    ...
    dashboard: {
      main_heading: 'Welcome to NuxtJS Base Template!',
      sub_heading: 'A lightweight boilerplate about the development of a NuxtJS project.',
      new_users: 'New Users',
    ...
    landing: {
      ...
      nuxt: {
        ...
        description:
          'NuxtJS is extremely intuitive to work with and provides interactivity to the layout of any UI. It is composable so we can utilize these components and integrate them into one place. Hence the code becomes a lot more maintainable and flexible.',
      },
      laravel: {
