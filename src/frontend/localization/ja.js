export default {
  ...
  pages: {
    ...
    dashboard: {
      main_heading: 'NuxtJS Base Templateへようこそ！',
      sub_heading: 'NuxtJSプロジェクトの開発に関する軽量の定型文。',
      new_users: '新しいユーザー',
      total_sales: '総売上高',
      total_orders: '総注文数',
    },
    ...
    landing: {
      ...
      nuxt: {
        heading: '高速で直感的なUI',
        description:
          'NuxtJSは非常に直感的に操作でき、UIのレイアウトに双方向性を提供します。 これらのコンポーネントを利用して1つの場所に統合できるように、構成可能です。 したがって、コードははるかに保守可能で柔軟になります。',
      },
      laravel: {
        heading: '強力なAPI',
        description:
  ...
  menu: {
    ...
    support: 'サポート',
    styleguide: 'スタイルガイド',
    activate: 'アカウントをアクティブ化',
    forgotPassword: 'パスワードをお忘れですか',
    resetPassword: 'パスワードを再設定する',
    createAccount: '無料アカウントを作成する',
  },
  table: {
    no_data: 'データなし。',
  },
